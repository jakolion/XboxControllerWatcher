namespace XboxControllerWatcher
{
    public class Constants
    {
        ...
        public const int POLL_INTERVAL_HOTKEY = 20;
        public const int POLL_INTERVAL_HOTKEY_INACTIVE = 1000;
        public const int POLL_INTERVAL_BATTERY_LEVEL = 1000;
        public const int WINDOW_HOTKEY_DETECTED_SHOW_DURATION = 3000;
